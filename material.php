 ...
 */
    ...
    class materialPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddLookupField('qrcode_idqrcode', 'qrcode', new IntegerField('idqrcode'), new StringField('qrlink', false, false, false, false, 'qrcode_idqrcode_qrlink', 'qrcode_idqrcode_qrlink_qrcode'), 'qrcode_idqrcode_qrlink_qrcode');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'qrcode_idqrcode', 'qrcode_idqrcode_qrlink', 'QR-код'),
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['qrcode_idqrcode'])
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('qrcode_idqrcode', 'qrcode_idqrcode_qrlink', 'QR-код', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('materialGrid_qrcode_idqrcode_qrlink_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('materialGrid_qrcode_idqrcode_qrlink_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for qrcode_idqrcode field
            //
            $editor = new ComboBox('qrcode_idqrcode_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            ...
            $lookupDataset->setOrderByField('qrlink', 'ASC');
            $editColumn = new LookUpEditColumn(
                'QR-код', 
                'qrcode_idqrcode', 
                $editor, 
                $this->dataset, 'idqrcode', 'qrlink', $lookupDataset);
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('materialGrid_qrcode_idqrcode_qrlink_handler_print');
            $grid->AddPrintColumn($column);
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('materialGrid_qrcode_idqrcode_qrlink_handler_export');
            $grid->AddExportColumn($column);
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('materialGrid_qrcode_idqrcode_qrlink_handler_compare');
            $grid->AddCompareColumn($column);
        ...
        protected function doRegisterHandlers() {
            ...
            $column = new TextViewColumn('qrcode_idqrcode', 'qrcode_idqrcode_qrlink', 'QR-код', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'materialGrid_qrcode_idqrcode_qrlink_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('qrcode_idqrcode', 'qrcode_idqrcode_qrlink', 'QR-код', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'materialGrid_qrcode_idqrcode_qrlink_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('qrcode_idqrcode', 'qrcode_idqrcode_qrlink', 'QR-код', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'materialGrid_qrcode_idqrcode_qrlink_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('qrcode_idqrcode', 'qrcode_idqrcode_qrlink', 'QR-код', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'materialGrid_qrcode_idqrcode_qrlink_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
